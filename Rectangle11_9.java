public class Rectangle11_9 {
  ...
  Rectangle11_9(int width, int height) {
    this.width = width;
    this.height = height;
    this.x = 0;
    this.y = 0;
  }
  Rectangle11_9(int x, int y, int width, int height) {
    this.width = width;
    this.height = height;
    this.x = x;
    this.y = y;
  ...
  Rectangle intersect(Rectangle11_9 r) {
